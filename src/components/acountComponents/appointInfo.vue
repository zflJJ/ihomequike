<template>
  <div id="appoint-info">
          ...
          <div class="plate">
              <div class="plate-info">
                <p>
                  ...
                  <span class="yellow-s" v-else-if="orderData.parklotKind === 2">室外+室外</span>
                </p>
                <span class="daohang-img" @click="guide"></span>
    ...
    <template v-if ="orderData.state === 1302 && orderData.type === 2" >
      <div class="cancel-order p-a t-c" @click="lockModel">控制车锁</div>
    </template>
  ...
  methods: {
    ...
    dispoceOrderDat(objDatas){
      ...
      if(objDatas.enterTime === null){
        ...
        objDatas.enterTime = enterTime.substr(0,15);
      }
