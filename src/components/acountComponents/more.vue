  ...
  <div id="setting-more">
    ...
    <div class="content-box" ref="moreContent">
      <div class="more-content">
        ...
        <div class="service-xy list-tp clearfix p-r">
          <div class="info f-l">服务协议</div>
          <div class="ct f-r clearfix p-r">
            <span class="name"></span>
            <span class="icon p-a"></span>
          </div>
          <a class="p-a" href="http://119.23.25.170:8088/api/AppMobile/service_protocol.html"></a>
        </div>
        <div class="quit-login" ><span @click="quitLogin" ref="quitBtn">退出账号</span></div>
      </div>
    </div>
